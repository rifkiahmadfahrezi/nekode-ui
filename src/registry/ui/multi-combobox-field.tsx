...
export interface MultiComboboxFieldProps {
  ...
  placeholder?: string;
  emptyText?: string;
  options: MultiComboboxFieldOption[];
  name?: string;
  id?: string;
  value: string[];
...
export const MultiComboboxField = React.forwardRef<
  HTMLInputElement,
    ...
    return (
      ...
      >
        ...
        <Combobox
          multiple
          items={options}
          itemToStringValue={(item: MultiComboboxFieldOption) => item.label}
          value={selectedItems}
          onValueChange={(items: MultiComboboxFieldOption[]) =>
...
MultiComboboxField.displayName = "MultiComboboxField";
